...
- use `planner` agent to design the feature following ResearchHub layer conventions
- provide the implementation blueprint (Domain → Application → Infrastructure → Api → Tests)
