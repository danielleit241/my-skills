...
**If direct selection:** Show preset picker and skip to Phase 3. Available presets are defined in [styles-presets.md](./references/styles-presets.md).
...
Based on mood, generate 3 distinct single-slide HTML previews showing typography, colors, animation, and overall aesthetic. Read [styles-presets.md](./references/styles-presets.md) for available presets and their specifications.
...
- [html-template.md](./templates/html-template.md) — HTML architecture and JS features
- [viewport-base.css](./templates/viewport-base.css) — Mandatory CSS (include in full)
